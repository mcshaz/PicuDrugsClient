...
import { DrugDoseUnit, InfusionRateUnit, SiConcentration } from '../';
...
describe('InfusionRateUnit', () => {
    ...
    it('downconverts using "as" methods', () => {
        const iru = new InfusionRateUnit(-3, siUnit.gram, true, false);
        const ru = iru.toDrugDoseUnit();
        assert.strictEqual( ru.toString(), 'milligrams/kg');
        const u = iru.tosiUnitMeasure();
