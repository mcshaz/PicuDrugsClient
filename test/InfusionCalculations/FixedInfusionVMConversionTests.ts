...
describe('fixedVMConversion',()=>{
    ...
    it('has tested relevant methods', () => {
        chai.expect([...methodsTested]).to.have.same.members([2,3,4,6,7]);
    });
});
interface fixedVMTestData {wt:number,viewRows:FixedInfusionView[],vm:FixedInfusionDrugVM}
function getFixedInfusionVMTestData(): fixedVMTestData[] {
    return [
        {
